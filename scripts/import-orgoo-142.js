...
//
// ⚠️ ХУУЧИРСАН — ДАХИН БҮҮ АЖИЛЛУУЛ (2026-09-16).
//    Доорх өрүүд 2026 оны 01 сарынх. 2026-09-16-нд Төрийн банкны биллерийн
//    файлаар (нийт 21,880,000₮) шинэчилсэн тул энэ скриптийг --commit-тэй
//    ажиллуулбал өрийг 8 сараар БУЦААНА. Одоо ашиглах нь:
//        node scripts/import-orgoo-142-biller.js
//    Энэ файл нь зөвхөн анхны бүртгэлийн түүх, гараажны эх сурвалжийн тэмдэглэл.
//
...
// Даргын засвар: 1210 гараажгүй БОЛСОН; 602 хоёр гараажтай БОЛСОН;
// тоот нь бичигдээгүй байсан 17-р мөр нь 802-ынх (тэгснээр 802 хоёр зогсоолтой);
// 28-р мөр нь 803 биш 904-ынх — иймд 803 гараажгүй болж байгаа нь нийцнэ;
// тоот нь бичигдээгүй байсан 11-р мөр нь 706-ынх.
// Айлд хамаарахгүй үлдсэн 3 мөр: 2 ба 21 эзэнгүй, 1-р мөр (1210) гараажгүй болсон.
...
// Хуучирсан өгөгдлөөр 2026.09-ийн өрийг дарж бичихээс хамгаалав (дээрх тайлбарыг үз).
if (COMMIT && !process.argv.includes('--force-stale')) {
  console.error('\n⛔ Энэ скриптийн өр 2026.01-нийх — хуучирсан.');
  console.error('   Одоо ашиглах нь: node scripts/import-orgoo-142-biller.js --commit');
  console.error('   Үнэхээр эндээс бичих бол: --force-stale нэмнэ.');
  process.exit(1);
}
...
// «Дулаан зогсоол эзэмшигчдийн бүртгэл» + даргын засвар (2026-09-13). Нийт 26 зогсоол.
const GARAGE = {
  '405': 2, '501': 1, '602': 2, '607': 1, '706': 1, '708': 1, '709': 1,
  '802': 2, '809': 2, '904': 1, '906': 2, '908': 1, '909': 2,
