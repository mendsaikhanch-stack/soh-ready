...
//
// БАТАЛГАА:
//   • Дарга зургаан байрны харгалзааг өөрөө өгсөн (доорх RENAME-г үз) —
//     Excel дэх дугаар нь тухайн байрны БАНКНЫ КОД байжээ.
//   • Бие даасан нотолгоо: 24-ийн 14 тоот DB-д алга, оронд нь «23Б» байртай
//     14 тоот (37м², 48,500₮ — 24-ийн загвартай яг таарна) ганцаар байна.
//     Хэн нэг нь тэр мөрийг гараар «23Б» болгож зассан нь 24→23Б-г баталж байна.
//
...
//
// Дарга 2026-09-24: «Банкны код нь 22А-89, 22Б-88, 23А-23, 23Б-24, 23В-25,
// 23Г-26». Өөрөөр хэлбэл Excel дэх дугаар нь банкны код байсан бөгөөд бүх
// зургаан байрны харгалзаа БАТЛАГДСАН. (22А/22Б нь миний анхны таамгийн
// ЭСРЭГ байсан — 89 нь 22Б биш 22А.)
const RENAME = [
  { from: '89',  to: '22А', units: 145 },
  { from: '88',  to: '22Б', units: 145 },
  { from: '23',  to: '23А', units: 37 },
  { from: '24',  to: '23Б', units: 35 },
  { from: '25',  to: '23В', units: 37 },
  { from: '26',  to: '23Г', units: 37 },
  { from: '23Б', to: '23Б', units: 1 },   // 24-өөс гараар зассан ганц мөр — хөндөхгүй
];
...
async function run() {
  ...
  console.log('\n🧭 Солих төлөвлөгөө:');
  for (const m of plan) {
    console.log(`   «${pad(m.from, 3)}» → «${pad(m.to, 4)}»  ${String(m.units).padStart(3)} айл`);
  }
  ...
  if (!COMMIT) {
    ...
    console.log('   Бичихдээ: node scripts/rename-badrakh-buildings.js --commit');
    return;
  }
