...
> Холбогдох контакт: `tugsorchin@yahoo.com` · `9401-9927`

> ⚠️ **Анхаар:** энэ баримт 2026-05-14-ны байдлаар бичигдсэн тул доорх
> `hotol.mn` хаягууд **хуучирсан** — бодит домэйн нь **`khotol.com`**.
> Google Play-ийн бодит, шинэчилсэн материал болон заавар нь
> [`../playstore/`](../playstore/) фолдерт байгаа —
> Play Console-д хуулах текст, зураг, closed testing-ийн төлөвлөгөөг
> **тэндээс** ав.
