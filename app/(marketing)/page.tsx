...
const pricing = [
  {
    ...
    price: '0',
    period: 'Үүрд',
    desc: 'Жижиг СӨХ-д тохиромжтой',
    features: ['50 хүртэл айл', 'Төлбөрийн бүртгэл', 'Зарлал', 'Засварын хүсэлт'],
    missing: ['Санхүүгийн тайлан', 'Excel импорт', 'Санал хураалт', 'Тусгай дэмжлэг'],
    cta: 'Үнэгүй эхлэх',
    popular: false,
  },
  {
    ...
    price: '50,000',
    period: '/сар',
    desc: 'Ихэнх СӨХ-д тохиромжтой',
    features: ['200 хүртэл айл', 'Бүх функц', 'Excel/CSV импорт', 'Санхүүгийн тайлан', 'Санал хураалт', 'Имэйл дэмжлэг'],
    missing: ['Тусгай тохиргоо', '24/7 дэмжлэг'],
    cta: 'Эхлэх',
    popular: true,
  },
  {
    ...
    price: '150,000',
    period: '/сар',
    desc: 'Том СӨХ, хороолол',
    features: ['Хязгааргүй айл', 'Бүх функц', 'Excel/PDF импорт', 'Нарийвчилсан тайлан', 'Санал хураалт', '24/7 утасны дэмжлэг', 'Тусгай тохиргоо', 'Онлайн төлбөр (QPay)'],
    missing: [],
    cta: 'Холбогдох',
    popular: false,
  },
      ...
      <section id="pricing" className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500">Нэг айлд ногдох дүн ~500₮ — кофены үнээс бага</p>
          </div>
          <div className="grid md:grid-cols-3 gap-4">
            {pricing.map(p => (
