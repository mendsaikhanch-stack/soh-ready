...
const features: Feature[] = [
  ...
  { name: 'Ажилчдын цалин тооцоо', status: 'todo', category: 'СӨХ Админ', note: 'Ажилчдын цалин бодох' },
  { name: 'Лифт засвар хуваарь', status: 'todo', category: 'СӨХ Админ', note: 'Лифтний засвар үйлчилгээ төлөвлөх' },
  { name: 'Орцны хаалга нээх (smart lock)', status: 'todo', category: 'Оршин суугч', note: 'Bluetooth/NFC хаалга нээх' },
  { name: 'Visitor management', status: 'todo', category: 'Оршин суугч', note: 'Зочны QR код + нэвтрэх бүртгэл' },
