 ...
 *  Хоосон үлдээсэн талбар гэрээн дээр цэгтэй мөр болж хэвлэгдэнэ, гараар
 *  бөглөнө. Утга оруулмагц бүх СӨХ-ийн гэрээнд автоматаар орно. */
export const PROVIDER = {
  company: 'Төгс Орчин ХХК',
  brand: 'Хотол',
  register: '5063299',     // улсын бүртгэлийн дугаар (тамган дээрх)
  address: 'Улаанбаатар хот',
  phone: '9401-9927',
  email: 'tugsorchin@yahoo.com',
  website: 'khotol.com',
  bank: 'Хас',             // банкны нэр
  bankAccount: '5005176240',
  /** Данс нь компанийн бус, хувь хүний нэр дээр байгаа тул гэрээнд эзэмшигчийг
   *  нь заавал бичнэ — эс тэгвэл Захиалагчийн нягтлан төлбөрийг тулгаж чадахгүй. */
  bankAccountHolder: 'Ч.Мэндсайхан',
  representative: 'Ч.Мэндсайхан',
